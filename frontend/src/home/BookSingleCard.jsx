...
const BookSingleCard = ({ item }) => {
    ...
    return (
        <div key={item._id} className='border-2 border-gray-500 px-4 py-2 m-4 rounded-lg relative hover:shadow-xl'>
            {
                showmodel && (
            ...
            <div className='flex justify-between items-center gap-x-2 mt-4 p-4'>
                <BiShow className='text-3xl text-green-800 hover:text-black' onClick={()=>{setShowmodel(true)}}/>
